...
batting_stats_file_path = os.path.join("scraped_data", "ilt20_batting_stats_with_nationality_2025.csv")
batting_stats = pd.read_csv(batting_stats_file_path)

bowling_stats_file_path = os.path.join("scraped_data", "ilt20_bowling_stats_with_nationality_2025.csv")
bowling_stats = pd.read_csv(bowling_stats_file_path)
