...
bowling_stats = pd.read_csv("ilt20_bowling_stats_2025.csv")
...
#the mat_bowling column is also removes as its the same as the batting, which will be renamed to just matches
merged_stats = merged_stats.drop(columns=["Span_batting", "Span_bowling", "Player Profile URL", "Mat_bowling"])
